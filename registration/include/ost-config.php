...
define('SECRET_SALT','hYKKX0qY0ZyDtqrZmJLtAXRjZuWjcoSo');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','lkolanowski3@gmail.com');
...
define('DBNAME','koleonme_osticket');
define('DBUSER','koleonme_osticket');
define('DBPASS','U~i$%Nx?uN03');
